...
public interface FilmRepository extends CrudRepository<Film, Long> {
    ...
    @Query(value = "SELECT COUNT(*) FROM user_planed_film_list WHERE film_id = :id", nativeQuery = true)
    int checkIfFilmExistsInPlanedList(@Param("id") Long id);
    ...
    @Transactional
    @Modifying
    @Query(value = "DELETE FROM user_planed_film_list WHERE film_id = :id", nativeQuery = true)
    void deleteFilmFromPlanedList(@Param("id") Long id);
}
